...
background_image_url = "https://business.uokerbala.edu.iq/wp/en/wp-content/uploads/sites/2/2024/10/photo_2024-10-21_10-36-17.jpg"  # Replace with your image URL
...
# Custom CSS to change input and selectbox label colors to white
input_label_css = """
<style>
/* For text and number input labels and selectbox label */
...
div.stButton > button {
    ...
    background-color: blue; /* Optional: change background color if needed */
}
</style>
"""
